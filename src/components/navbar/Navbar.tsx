    ...
    >
      ...
      >
        <div className="flex h-[65%] xl:h-full xl:justify-between xl:items-center">
          ...
          {/* LOGO */}
          <Link
            aria-label="Versatile Indian Storefront logo, click to go to the homepage"
            href="/"
            className={`font-bold font-sansita tracking-wide italic flex items-center text-green-4 text-2xl xl:h-full xl:items-end xl:pb-1`}
          >
            Versa<span className="text-green-3">Indie</span>
          </Link>
          <SearchBar />
          <Login /> 
