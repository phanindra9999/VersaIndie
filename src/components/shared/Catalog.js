  ...
  products: [
    {
      ...
      old_price: 0,
      price: 1.99,
      search_words: ["potato", "chips"],
    },
    {
      id: 2,
      category: "sweet",
      image: "/images/products/snacks/jalebi.webp",
      name: "Jalebi",
      old_price: 0,
      price: 2.08,
      search_words: ["Jalebi", "jalebi","sweet"],
    },
    {
      id: 3,
      category: "salty",
    ...
    },
    {
      id: 4,
      category: "hot",
      image: "/images/products/snacks/samosa.webp",
      name: "Samosa",
      old_price: 0,
      price: 1.50,
      search_words: ["samosa","hot","Samosa"],
    },
    {
      id: 5,
      category: "solid",
      image: "/images/products/snacks/pakoda.webp",
      name: "Pakoda",
      old_price: 0,
      price: 1.39,
      search_words: ["Pakoda", "pakoda", "vegetarian"],
    },
    {
      id: 6,
      category: "hotdrink",
      image: "/images/products/snacks/chai.webp",
      name: "Chai",
      old_price: 0,
      price: 1.19,
      search_words: ["Chai", "chai", "hotdrink"],
    },
    {
      id: 7,
      category: "hot spices",
      image: "/images/products/snacks/momos.webp",
      name: "Momos",
      old_price: 2.2,
      price: 2.89,
      search_words: ["momos","Momos","Chicken"],
    },
  ],
};
  ...
  products: [
    {
        id: 1,
        category: "bread",
        image: "/images/products/full-fridge/egg-puff.webp",
        name: "Egg Puff",
        old_price: 2.0,
        price: 4.01,
        search_words: ["egg puff", "Egg Puff", "puffs"],
    },
    {
      id: 2,
      category: "solid hot",
      image: "/images/products/full-fridge/chekkalu.webp",
      name: "Chekkalu",
      old_price: 1.0,
      price: 3.28,
      search_words: ["chekkalu", "Chekkalu", "solid"],
    },
    {
      id: 3,
      category: "hot",
      image: "/images/products/full-fridge/karalu.webp",
      name: "Karalu",
      old_price: 0.56,
      price: 3.68,
      search_words: ["karalu", "karalu", "solid hot"],
    },
    {
      id: 4,
      category: "biscuits",
      image: "/images/products/full-fridge/kharibiscuits.webp",
      name: "Kharibiscuits",
      old_price: 0.89,
      price: 2.98,
      search_words: ["kharibiscuits", "kharibiscuits", "biscuits"],
    },
    {
        id: 5,
        category: "bread",
        image: "/images/products/full-fridge/veg-puff.webp",
        name: "Veg Puff",
        old_price: 2.0,
        price: 4.01,
        search_words: ["veg puff", "Veg Puff", "puffs"],
    },
  ...
  products: [
    {
      ...
      old_price: 0,
      price: 4.99,
      search_words: ["indian tuna", "fish", "india"],
    },
    {
      id: 2,
      category: "vegetableSauce",
      image: "/images/products/canneds/tomato-sauce.webp",
      name: "Indian Tomato Sauce",
      old_price: 1.35,
      price: 0.89,
      search_words: ["indian tomato sauce", "indian tomato Sauce"],
    },
    {
      id: 3,
      category: "vegetable",
      ...
      old_price: 0.36,
      price: 2.86,
      search_words: ["indian beans", "indian", "beans", "bean", "indian bean"],
    },
    {
      id: 4,
      category: "fish",
      image: "/images/products/canneds/sardines.webp",
      name: "Indian Sardines",
      old_price: 0,
      price: 2.96,
      search_words: ["indian sardines", "indian", "sardine", "indian sardine"],
    },
    {
      id: 5,
      category: "fruit",
      ...
      old_price: 0,
      price: 3.4,
      search_words: ["indian peach", "indian", "peach", "peaches"],
    },
    {
      id: 6,
      category: "fruit",
      image: "/images/products/canneds/pineapple.webp",
      name: "Indian Pineapple",
      old_price: 0,
      price: 3.6,
      search_words: ["indian pineapple", "indian", "pineapple", "pineapples"],
    },
  ],
};
...
export const beverages = {
  ...
  products: [
    ...
    },
    {
      id: 13,
      category: "drink",
      image: "/images/products/beverages/thumsup.webp",
      name: "Thumsup",
      old_price: 0,
      price: 3.19,
      search_words: ["thumsup", "drink"],
    },
    {
      id: 14,
      category: "juice",
      image: "/images/products/beverages/limca.webp",
      name: "limca",
      old_price: 0,
      price: 3.19,
      search_words: ["limca", "drink"],
    },
    {
      id: 15,
      category: "juice",
      image: "/images/products/beverages/pulpy orange.webp",
      name: "pulpy orange",
      old_price: 0,
      price: 3.19,
      search_words: ["pulpy orange", "juice"],
    },
    {
      id: 16,
      category: "juice",
      image: "/images/products/beverages/real mango.webp",
      name: "real mango",
      old_price: 0,
      price: 3.19,
      search_words: ["real mango", "juice"],
    },
    {
      id: 17,
      category: "juice",
      image: "/images/products/beverages/campa.webp",
      name: "Campa",
      old_price: 0,
      price: 3.19,
      search_words: ["campa", "juice"],
    },
  ],
};
  ...
  products: [
    {
      id: 1,
      category: "fruit",
      image: "/images/products/fruits/jamakaya.webp",
      name: "Jamakaya",
      old_price: 1.99,
      price: 1.69,
      search_words: ["fruit", "fruits", "jamakaya", "jamakaya's"],
    },
    {
      id: 2,
      category: "fruit",
      image: "/images/products/fruits/Regipandu.webp",
      name: "Regipandu",
      old_price: 2.69,
      price: 2.39,
      search_words: ["regipandu", "fruit", "fruits", "Regipandu", "regipandlu"],
    },
    {
      id: 3,
      category: "fruit",
      image: "/images/products/fruits/iceapple.jpg",
      name: "Iceapple",
      old_price: 0.68,
      price: 0.48,
      search_words: ["iceapple", "fruit", "iceapples", "fruits"],
    },
    {
      id: 4,
      category: "fruit",
      image: "/images/products/fruits/mangos.webp",
      name: "Mangos",
      old_price: 4.39,
      price: 4.09,
      search_words: ["mangos", "mongos", "fruit", "fruits"],
    },
    {
      id: 5,
      category: "fruit",
      image: "/images/products/fruits/seetha palam.webp",
      name: "Seetha palam",
      old_price: 5.69,
      price: 5.19,
      search_words: ["seetha palam", "fruit", "fruits"],
    },
    {
      id: 6,
      category: "fruit",
