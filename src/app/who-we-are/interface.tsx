    ...
    <section className="flex flex-col items-center justify-start mx-auto min-h-screen py-20 relative px-64 xxl:px-28 xl:px-20 lg:px-10 md:px-0">
      ...
      >
        ...
        <p className="text-lg text-gray-700 mb-2 whitespace-normal">
          Versatile Indian Storefront(VersaIndie) is your one-stop solution for all your grocery needs. Our
        ...
        <p className="text-lg mb-4 text-gray-700 whitespace-normal">
          At Versatile Indian Storefront(VersaIndie), our mission is simple: to revolutionize your grocery
        ...
        <p className="text-lg mb-4 text-gray-700 whitespace-normal">
          Quality is the heart of VersaIndie. We source our products carefully and
          ...
          every item we deliver. With VersaIndie, you can shop with confidence,
        ...
        <p className="text-lg mb-4 text-gray-700 whitespace-normal">
          Thank you for choosing VersaIndie as your trusted grocery partner.
